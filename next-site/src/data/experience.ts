...
export const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    description:
      'Acted as the first customer and provided in-depth feedback to the R&D team. Created deep technical content including code demos, blog posts, and YouTube videos (550K subscribers). Recognized as an Arm Ambassador.',
    achievements: [
