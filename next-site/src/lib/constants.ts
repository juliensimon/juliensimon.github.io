export const SITE = {
  ...
  description:
    'Julien Simon is an AI expert and Operating Partner at Fortino Capital. 685+ talks, 464+ articles, 521K YouTube subscribers. Author of The AI Realist newsletter.',
...
export const METRICS = [
  { value: 464, suffix: '', label: 'Technical Posts' },
  { value: 685, suffix: '', label: 'Speaking Engagements' },
  { value: 521, suffix: 'K', label: 'YouTube Subscribers' },
