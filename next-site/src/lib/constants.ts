export const SITE = {
  ...
  description:
    'Julien Simon is an AI expert and Operating Partner at Fortino Capital. 685+ talks, 464+ articles, 508K YouTube subscribers. Author of The AI Realist newsletter.',
