export const SITE = {
  ...
  description:
    'Julien Simon is an AI expert and Operating Partner at Fortino Capital. 685+ talks, 473+ articles, 545K YouTube subscribers. Author of The AI Realist newsletter.',
