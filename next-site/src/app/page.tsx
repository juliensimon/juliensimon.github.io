...
export const metadata = buildMetadata({
  ...
  description:
    'Julien Simon — AI expert, Operating Partner at Fortino Capital. 684 talks, 440 articles, 494K YouTube subscribers. Former AWS & Hugging Face. Author of The AI Realist.',
  path: '/',
  keywords: [
    'AI expert',
    'machine learning',
