...
def main():
    ...
    # Find ALL AWS Medium posts
    aws_medium_files = glob.glob("blog/aws-medium-posts-and-images/**/*.html", recursive=True)
    
    # Remove index.html files
    aws_medium_files = [f for f in aws_medium_files if os.path.basename(f) != "index.html"]
